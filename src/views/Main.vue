  ...
  <div>
    <el-container>
      ...
      <div class="room-content">
        <ul class="room-list" v-for="(roomItem,roomKey) in roomList" :key="roomKey">
          <li
            class="room-item"
          ...
          >
            <div
              ...
              v-show="roomItemHover[roomKey] === undefined ? false : !roomItemHover[roomKey].hover"
            >&nbsp;&nbsp;&nbsp;</div>
            <div
              class="room-item-active"
              v-show="roomItemHover[roomKey] === undefined ? false : roomItemHover[roomKey].hover"
            >－</div>
            <router-link :to="{name:'RoomDetail',params:{id:roomItem.id}}">{{roomItem.name}}</router-link>
          </li>
        </ul>
      </div>
      <div class="social-content">
        <img :src="require('@assets/img/facebook-square-brands.svg')" width="20px" />
        <img :src="require('@assets/img/instagram-brands.svg')" width="20px" />
      </div>
      <div class="contact-content">
        <ul>
          <li>
            <img :src="require('@assets/img/phone-alt-solid.svg')" width="20px" />
            <span>02-17264937</span>
          </li>
          <li>
            <img :src="require('@assets/img/envelope-solid.svg')" width="20px" />
            <span>whitespace@whitespace.com.tw</span>
          </li>
          <li>
            <img :src="require('@assets/img/home-solid.svg')" width="20px" />
